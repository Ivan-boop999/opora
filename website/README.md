> Отложено при установке (2026-09-22): мини-апп живёт внутри Telegram, публичные страницы и SEO не нужны. Активируем по запросу владельца — тогда настроить, проверить и обновить эту запись и CHECKLIST.md.
# Публичный сайт
...
При подключении API/DTO явно добавь `@opora/contracts` и проверь обе стороны контракта. `@astrojs/react` нужен только для интерактивных React-islands.
